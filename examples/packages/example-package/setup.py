"""Cython configuration for example-package."""
...
INCLUDE_FILE_PATTERNS = [
    "example_package.utils",  # ✅ Compile: Business logic
    "example_package.validators",  # ✅ Compile: Validation logic
]

# Files NOT to compile (entry points)
EXCLUDE_FILE_PATTERNS = [
    "example_package.__init__",  # ❌ Don't compile: Entry point
]
